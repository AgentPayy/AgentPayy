...
> **Help us build the future of API monetization**

Thank you for your interest in contributing to AgentPay! We welcome contributions from developers of all skill levels. This guide will help you get started.
...
- 🧪 **Testing** - Write tests, test new features, report edge cases
- 🎨 **Examples** - Create integration examples and tutorials
- 💬 **Community Support** - Help other developers in Discord/GitHub
...
We use different testing frameworks for different components:

- **Smart Contracts**: Foundry (Solidity tests)
- **TypeScript SDK**: Jest
...
```typescript
// sdk/typescript/src/__tests__/AgentPayKit.test.ts
import { AgentPayKit } from '../AgentPayKit';

describe('AgentPayKit', () => {
  let agentPay: AgentPayKit;
  
  beforeEach(() => {
    agentPay = new AgentPayKit({
